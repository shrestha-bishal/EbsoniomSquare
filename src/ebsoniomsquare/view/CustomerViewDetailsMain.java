 ...
 */
public class CustomerViewDetailsMain extends javax.swing.JFrame {

    /**
     * Creates new form CustomerViewDetailsMain
     */
    public CustomerViewDetailsMain() {
        initComponents();
    ...
    //View Customer Details in the JTable
    ...
    private void initComponents() {
        ...
        if (viewCustomerDetailsTbl.getColumnModel().getColumnCount() > 0) {
            viewCustomerDetailsTbl.getColumnModel().getColumn(4).setMinWidth(0);
            viewCustomerDetailsTbl.getColumnModel().getColumn(4).setPreferredWidth(0);
            viewCustomerDetailsTbl.getColumnModel().getColumn(4).setMaxWidth(0);
        ...
        contactNumberOptionalFLd.setEditable(false);
        ...
        residentalCountryFld.setEditable(false);

        residentalPostalCodeFLd.setEditable(false);

        residentalStateFld.setEditable(false);

        residentalTownFld.setEditable(false);

        residentalSuburbFld.setEditable(false);

        residentalAddressLine2Fld.setEditable(false);

        residentalAddressLine1Fld.setEditable(false);
        ...
        deliveryCountryFld.setEditable(false);

        deliveryPostalCodeFLd.setEditable(false);

        deliveryStateFld.setEditable(false);
        ...
        postalCountryFld.setEditable(false);

        postalPostalCodeFLd.setEditable(false);

        postalStateFld.setEditable(false);

        postalTownFld.setEditable(false);

        postalSuburbFld.setEditable(false);

        postalAddressLine2Fld.setEditable(false);

        postalAddressLine1Fld.setEditable(false);
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                .addComponent(cancelBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//View Customer Details when Table Mouse CLicked
    ...
    private void cancelBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelBtnActionPerformed
         //Objects to Show Cancel Customer View Message
